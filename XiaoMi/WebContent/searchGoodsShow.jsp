...
<title><%=request.getParameter("name")%>相关产品</title>
...
<form action="GoodsController?op=searchGoodsShow&pageNum=1" style="display: inline-block;" method="post">
  <div class="box"">
	<div class="nav-box clearFix">
	 ...
	 <c:forEach items="${pageBean.pageDatas }" var="goods">
	 	<div class="match-box" style="width: 20%;height: 340px;margin-left: 60px">
	...
	<div style="position: fixed;bottom: 0;">
	        <span><a href="GoodsController?op=showGoodsByCategory&pageNum=1&name=${name}">
	        		首页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
				<c:if test="${pageBean.havePrePage }">
					<span><a href="GoodsController?op=showGoodsByCategory&pageNum=${pageBean.pageNum-1}&name=${name}">
					上一页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
				</c:if>
			...
			<span><a href="GoodsController?op=showGoodsByCategory&&pageNum=${pageBean.totalPages}&name=${name}">末页</a></span>
        </div>
