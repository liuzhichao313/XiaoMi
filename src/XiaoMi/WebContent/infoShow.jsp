...
<body>
 <div class="mianCont">
  <div class="top">
   ...
   <span class="topRight">
    <a href="xiaomi.html">我的小米</a>&nbsp;| 
    <a href="infoShow.jsp">我的订单</a>&nbsp;| 
  ...
  <div class="positions">
   当前位置：<a href="xiaomi.html">首页</a> &gt; <a href="#.html">会员中心</a>
    &gt; <a href="#" class="posCur">我的信息</a>
  </div><!--positions/-->
  <div class="cont">
    ...
    <dl class="helpNav vipNav">
     <dt>我的主页</dt>
      <dd>
       ...
       <a href="infoShow.jsp" class="vipCur">我的订单</a>
      </dd>
     <dt>账户设置</dt>
      <dd>
       <a href="#.html">个人信息</a>
      ...
      <dt>客户服务</dt>
       <dd>
        <a href="#.html">网站使用条款</a>
        <a href="#.html">网站免责声明</a>
        <a href="#.html">在线留言</a>
       </dd>
   ...
   <div class="contRight">
    ...
    <table class="vipOrder">
		<c:forEach items="${dingdan.entrySet()}" var="e">
     <tr>
		<br>
		...
		<td>支付方式<br />支付宝</td>
		<td><a href="dingDanController?op=pay&goods_id=${e.getValue().goods.id }"><strong>立即支付</strong></a></td>
     </tr>
	</c:forEach>
    </table><!--vipOrder/-->
    <br />
  ...
  <div class="inHelp">
   ...
   <div class="inHLeft">
    ...
    <ul class="inHeList">
     ...
     <li><a href="infoShow.jsp">我的订单</a></li>
     <div class="clears"></div>
    </ul><!--inHeList/-->
   </div><!--inHLeft/-->
   <div class="inHRight">
